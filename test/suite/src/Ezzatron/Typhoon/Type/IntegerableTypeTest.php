...
class IntegerableTypeTest extends \Ezzatron\Typhoon\Test\TypeTestCase
{
  /**
   * @return array
   */
  ...
  /**
   * @covers Ezzatron\Typhoon\Type\IntegerableType::__construct
   * @covers Ezzatron\Typhoon\Type\IntegerableType::typhoonCheck
