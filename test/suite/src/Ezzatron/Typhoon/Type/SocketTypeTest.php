...
class SocketTypeTest extends \Ezzatron\Typhoon\Test\TypeTestCase
{
  /**
   * @return array
   */
  ...
  /**
   * @covers Ezzatron\Typhoon\Type\SocketType::__construct
   * @covers Ezzatron\Typhoon\Type\SocketType::typhoonCheck
