...
class TupleTypeTest extends \Ezzatron\Typhoon\Test\TestCase
{
   ...
   * @covers Ezzatron\Typhoon\Type\Composite\TupleType::typhoonCheck
   * @group type
  ...
  /**
   * @covers Ezzatron\Typhoon\Type\Composite\TupleType
   * @group type
   * @group composite-type
   * @group core
   */
