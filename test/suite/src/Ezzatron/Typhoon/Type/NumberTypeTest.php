...
class NumberTypeTest extends \Ezzatron\Typhoon\Test\TypeTestCase
{
  /**
   * @return array
   */
  ...
  /**
   * @covers Ezzatron\Typhoon\Type\NumberType::__construct
   * @covers Ezzatron\Typhoon\Type\NumberType::typhoonCheck
