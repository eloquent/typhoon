...
class ParameterListAssertionTest extends \Eloquent\Typhoon\Test\TestCase
{
  ...
  /**
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::assert
   * @group assertion
   * @group core
   */
  public function testAssertUseParameterAssertion()
  {
    ...
    $parameter_0 = Phake::mock('Eloquent\Typhoon\Parameter\Parameter');
    $parameter_1 = Phake::mock('Eloquent\Typhoon\Parameter\Parameter');
  ...
  /**
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::parameterAssertion
   * @group assertion
   * @group core
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::setParameterList
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::parameterList
   * @group assertion
   * @group core
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::setArguments
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion::arguments
   * @group assertion
   * @group core
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Assertion\ParameterListAssertion
   * @group assertion
   * @group core
   */
