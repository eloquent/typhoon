...
class StreamTypeTest extends \Eloquent\Typhoon\Test\TypeTestCase
{
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::getMetaData
   * @group types
   * @group type
   * @group dynamic-type
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::modeMatches
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::modeIsRead
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::modeIsWrite
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::configureAttributeSignature
   * @group types
   * @group type
   * @group dynamic-type
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Type\StreamType::__construct
   * @covers Eloquent\Typhoon\Type\StreamType::typhoonCheck
