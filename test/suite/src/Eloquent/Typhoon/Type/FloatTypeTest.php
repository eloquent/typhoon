...
class FloatTypeTest extends \Eloquent\Typhoon\Test\TypeTestCase
{
  /**
   * @return array
   */
  ...
  /**
   * @covers Eloquent\Typhoon\Type\FloatType::typhoonCheck
  ...
  /**
   * @covers Eloquent\Typhoon\Type\FloatType::typhoonName
   * @group types
   */
