...
class UnserializeMethodTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_issue = new UnserializeMethod(
    ...
    public function testAccept()
    {
        ...
        Phake::when($visitor)
            ->visitUnserializeMethod(Phake::anyParameters())
            ->thenReturn('foo')
        ;

        $this->assertSame('foo', $this->_issue->accept($visitor));
        Phake::verify($visitor)
            ->visitUnserializeMethod($this->identicalTo($this->_issue))
        ;
    }
}
