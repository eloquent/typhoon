...
/**
 * @covers \Eloquent\Typhoon\CodeAnalysis\Issue\ParameterIssue\DocumentedParameterUndefined
 ...
 */
class DocumentedParameterUndefinedTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_issue = new DocumentedParameterUndefined(
    ...
    public function testAccept()
    {
        ...
        Phake::when($visitor)
            ->visitDocumentedParameterUndefined(Phake::anyParameters())
            ->thenReturn('foo')
        ;

        $this->assertSame('foo', $this->_issue->accept($visitor));
        Phake::verify($visitor)
            ->visitDocumentedParameterUndefined($this->identicalTo($this->_issue))
        ;
    }
}
