...
/**
 * @covers \Eloquent\Typhoon\CodeAnalysis\Issue\ParameterIssue\UndocumentedParameter
 ...
 */
class UndocumentedParameterTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_issue = new UndocumentedParameter(
    ...
    public function testAccept()
    {
        ...
        Phake::when($visitor)
            ->visitUndocumentedParameter(Phake::anyParameters())
            ->thenReturn('foo')
        ;

        $this->assertSame('foo', $this->_issue->accept($visitor));
        Phake::verify($visitor)
            ->visitUndocumentedParameter($this->identicalTo($this->_issue))
        ;
    }
}
