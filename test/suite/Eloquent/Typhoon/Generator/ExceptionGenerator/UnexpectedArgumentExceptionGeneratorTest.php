...
class UnexpectedArgumentExceptionGeneratorTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_generator = new UnexpectedArgumentExceptionGenerator(
            $this->_renderer
        );
    }
    ...
    public function testGenerate()
    {
        ...
        $expected = file_get_contents(
            __DIR__.
            '/../../../../../src/Eloquent/Typhoon/TestFixture/GeneratorExamples/Exception/ExampleUnexpectedArgumentException.php'
        );
