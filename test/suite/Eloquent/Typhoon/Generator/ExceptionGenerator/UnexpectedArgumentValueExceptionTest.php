...
class UnexpectedArgumentValueExceptionGeneratorTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_generator = new UnexpectedArgumentValueExceptionGenerator(
            $this->_renderer
        );
    }
    ...
    public function testGenerate()
    {
        ...
        $this->assertSame('\Typhoon\Exception\UnexpectedArgumentValueException', $className->string());
    }
}
