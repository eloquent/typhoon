...
class TypeInspectorGeneratorTest extends MultiGenerationTestCase
{
    protected function setUp()
    {
        ...
        $this->_generator = new TypeInspectorGenerator(
            $this->_renderer
        );
    }
    ...
    public function testGenerate()
    {
        ...
        $this->assertSame('\Typhoon\TypeInspector', $className->string());
    }
}
