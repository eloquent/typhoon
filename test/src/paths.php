...
if (!defined('TYPHOON_TEST_BIN_DIR')) define('TYPHOON_TEST_BIN_DIR', TYPHOON_TEST_DIR.DIRECTORY_SEPARATOR.'bin');
if (!defined('TYPHOON_TEST_CONFIG_DIR')) define('TYPHOON_TEST_CONFIG_DIR', TYPHOON_TEST_DIR.DIRECTORY_SEPARATOR.'config');
