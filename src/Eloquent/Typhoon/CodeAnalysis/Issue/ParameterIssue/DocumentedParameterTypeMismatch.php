...
class DocumentedParameterTypeMismatch extends AbstractParameterRelatedIssue implements ParameterIssueInterface
{
    /**
    ...
    public function accept(IssueVisitorInterface $visitor)
    {
        ...
        return $visitor->visitDocumentedParameterTypeMismatch($this);
    }
