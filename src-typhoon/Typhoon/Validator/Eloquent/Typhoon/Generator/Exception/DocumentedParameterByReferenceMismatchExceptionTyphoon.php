<?php
namespace Typhoon\Validator\Eloquent\Typhoon\Generator\Exception;


class DocumentedParameterByReferenceMismatchExceptionTyphoon extends \Typhoon\AbstractValidator
{
