<?php
namespace Typhoon\Validator\Eloquent\Typhoon\Generator\ExceptionGenerator;


class UnexpectedArgumentValueExceptionGeneratorTyphoon extends \Typhoon\AbstractValidator
{
