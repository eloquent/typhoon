...
class ParseExceptionTyphoon extends Validator
{
    public function validateConstruct(array $arguments)
    {
        ...
        if ($argumentCount < 2) {
            if ($argumentCount < 1) {
                throw new MissingArgumentException('message', 0, 'string');
            }
        ...
        $check = function($argument, $index) {
            ...
            if (!$check($argument)) {
                throw new UnexpectedArgumentValueException('message', $index, $argument, 'string');
            }
        };
        $check($arguments[0], 0);
