<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\Configuration;


class RuntimeConfigurationTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
