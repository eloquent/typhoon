<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\ClassMapper\Exception;


class UndefinedClassExceptionTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
