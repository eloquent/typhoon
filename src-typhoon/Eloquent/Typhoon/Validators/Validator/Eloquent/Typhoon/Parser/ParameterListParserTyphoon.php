<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\Parser;


class ParameterListParserTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
