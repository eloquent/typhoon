<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\Generator\ExceptionGenerator;


class UnexpectedArgumentValueExceptionGeneratorTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
