<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\Resolver;


class ParameterListClassNameResolverTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
