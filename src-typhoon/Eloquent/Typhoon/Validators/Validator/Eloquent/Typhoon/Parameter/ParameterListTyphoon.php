<?php
namespace Eloquent\Typhoon\Validators\Validator\Eloquent\Typhoon\Parameter;


class ParameterListTyphoon extends \Eloquent\Typhoon\Validators\AbstractValidator
{
