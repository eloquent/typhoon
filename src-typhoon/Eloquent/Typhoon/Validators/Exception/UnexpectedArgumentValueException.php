<?php
namespace Eloquent\Typhoon\Validators\Exception;


final class UnexpectedArgumentValueException extends UnexpectedInputException
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Eloquent\Typhoon\Validators\TypeInspector $typeInspector = null)
    {
        if ((null === $typeInspector))
        {
            ($typeInspector = (new \Eloquent\Typhoon\Validators\TypeInspector()));
        }
