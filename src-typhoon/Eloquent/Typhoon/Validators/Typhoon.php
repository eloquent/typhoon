...
abstract class Typhoon
{
    ...
    {
        ($validatorClassName = ('Eloquent\\Typhoon\\Validators\\Validator\\' . $className . 'Typhoon'));
    ...
    {
        return (new \Eloquent\Typhoon\Configuration\RuntimeConfiguration('Eloquent\\Typhoon\\Validators', false));
    }
